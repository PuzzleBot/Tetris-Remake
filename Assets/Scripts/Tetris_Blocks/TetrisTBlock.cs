...
/*T-shaped piece*/
public class TetrisTBlock : TetrisBlock {
	private static Material blockMaterial = Resources.Load("Materials/Piece4_Mat", typeof(Material)) as Material;

	private Vector3[][] rotationConfigurations;

	public TetrisTBlock() : base(4) {
		...
		rotationConfigurations [1][0].Set (2, 0, 0);
		rotationConfigurations [1][1].Set (2, 0, 1);
		rotationConfigurations [1][2].Set (1, 0, 1);
		rotationConfigurations [1][3].Set (2, 0, 2);
		...
		rotationConfigurations [2][3].Set (2, 0, 2);

		rotationConfigurations [3] = new Vector3[4];
		rotationConfigurations [3][0].Set (0, 0, 0);
		rotationConfigurations [3][1].Set (0, 0, 1);
		rotationConfigurations [3][2].Set (1, 0, 1);
		rotationConfigurations [3][3].Set (0, 0, 2);
